...
@app.get("/vitals")
def get_vitals_compat(hours: int = Query(24, ge=1, le=24*30), patient_id: str = Query("todd")) -> List[Dict[str, Any]]:
    return _serve_vitals(hours, patient_id)

@app.get("/api/v1/vitals")
def get_vitals_v1(hours: int = Query(24, ge=1, le=24*30), patient_id: str = Query("todd")) -> List[Dict[str, Any]]:
    return _serve_vitals(hours, patient_id)
